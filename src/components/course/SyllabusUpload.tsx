        ...
        <div className="space-y-3">
            ...
            <div className="relative">
                ...
                <label
                    ...
                    className={`flex items-center justify-center gap-2 w-full px-4 py-2.5 border-2 border-dashed rounded-lg cursor-pointer transition-all ${isUploading
                            ? 'bg-gray-100 border-gray-300 cursor-not-allowed'
                            : 'border-[#0a66c2] hover:bg-blue-50 text-[#0a66c2]'
                        }`}
                >
                    {isUploading ? (
                        <>
